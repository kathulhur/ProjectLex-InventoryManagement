...
namespace ProjectLex.InventoryManagement.Desktop.ViewModels
{
    public class RoleListViewModel : ViewModelBase
    {
        ...
        public RoleListViewModel(RoleCollection roleCollection, NavigationStore navigationStore)
        {
            ...
            NavigateToModifyRoleCommand = new ModifyDataNavigateCommand(NavigateToModifyRole);
        ...
        public void NavigateToModifyRole(object obj)
        {
            ...
            _navigationStore.CurrentViewModel = new ModifyRoleViewModel(_roleCollection, roleViewModel);

        }

        public static RoleListViewModel LoadViewModel(RoleCollection roleCollection, NavigationStore navigationStore)
        {
            RoleListViewModel viewModel = new RoleListViewModel(roleCollection, navigationStore);
